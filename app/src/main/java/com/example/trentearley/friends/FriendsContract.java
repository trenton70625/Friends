...
/**
 * Created by te6933 on 2/15/2016.
 */
public class FriendsContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.trentearley.friends.provider";
    ...
    public static class Friends implements FriendsColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/" + CONTENT_AUTHORITY + ".friends";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/" + CONTENT_AUTHORITY + ".friends";
